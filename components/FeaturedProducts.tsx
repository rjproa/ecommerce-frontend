            ...
            result.map((product: ProductType) => {
              ...
              return (
                <CarouselItem key={id} className=" sm:basis-1/2 md:basis-1/3 lg:basis-1/4 group">
                  <div className="p-1">
                    <Card className="flex justify-between py-0 border border-gray-200 shadow-none max-w-75 mx-auto overflow-hidden">
                      ...
                      <div className="px-4 pb-4">
                        <span className="text-lg font-bold text-gray-700 rounded-full mr-3">s/ {price}</span>
